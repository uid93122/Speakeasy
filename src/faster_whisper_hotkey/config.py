...
try:
    ...
    logger.error(f"Configuration error while loading available_models_languages.json: {e}")
    raise
...
canary_source_target_languages = _CONFIG.get("canary_source_target_languages", ["en", "fr", "de", "es"])
